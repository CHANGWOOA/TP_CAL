...
const process = {
  ...
  delete: async (req, res) => {
    //댓글아이디(R_ID) 받아 해당 댓글 삭제
    // console.log("rep ctrl params : ", req.params);
    const result = await ser.repCtrl.delete(req.params.R_ID);

    res.redirect(`/board/detail/${req.params.P_ID}`);
  },
};
const views = {
  data: async (req, res) => {
